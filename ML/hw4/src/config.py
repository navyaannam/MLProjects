...
parser.add_argument('--lr_bgd', type=float, default=0.01, help='Learning rate for gradient descent')
parser.add_argument('--lr_sgd', type=float, default=0.01, help='Learning rate for stochastic gradient descent')
parser.add_argument('--bin_feats', type=bool, default=False, help='Use binary word features')
parser.add_argument('--lambda', type=str, default=1, help='Regularization')
